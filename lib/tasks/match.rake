namespace :match do
  ...
  task :recalculate => :environment do
    ...
    User.update_all(quota: 1200, number_of_wins: 0, number_of_losses: 0, number_of_crawls: 0, number_of_crawlings: 0, winning_streak: 0)
    Team.update_all(number_of_wins: 0, number_of_losses: 0)
