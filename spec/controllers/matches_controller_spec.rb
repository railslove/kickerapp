...
describe MatchesController, type: :controller do
  ...
  describe '#create' do
    ...
    specify do
      post :create, params: { league_id: league.slug, team1: { player1: user.id.to_s, player2: '' }, team2: { player1: user2.id.to_s, player2: '' }, set1: ['6', '3'], set2: ['',''], set3: ['',''] }
    ...
    it 'redirects to new_league_match if mobile' do
      ...
      post :create, params: { league_id: league.slug, team1: { player1: user.id.to_s, player2: '' }, team2: { player1: user2.id.to_s, player2: '' }, set1: ['6', '3'], set2: ['7','5'], set3: ['',''] }
    ...
    it 'adds a crawling match param if the was a crawling match' do
      post :create, params: { league_id: league.slug, team1: { player1: user.id.to_s, player2: '' }, team2: { player1: user2.id.to_s, player2: '' }, set1: ['6', '0'], set2: ['',''], set3: ['',''], crawling1: true }
